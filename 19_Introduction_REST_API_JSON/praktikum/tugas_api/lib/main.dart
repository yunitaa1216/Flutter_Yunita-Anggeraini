...
class _MyHomePageState extends State<MyHomePage> {
  late Dio _dio;
  String _avatarUrl = '';
  String _avatarText = ''; // Tambahkan variabel untuk teks avatar
    ...
    try {
      ...
      if (response.statusCode == 200) {
        setState(() {
          ...
          _avatarText = 'Avatar URL: ${response.requestOptions.uri.toString()}'; // Tambahkan teks avatar
        });
      } else {
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 20),
            Text(
              _avatarText, // Tampilkan teks avatar di sini
              style: TextStyle(fontSize: 14),
            ),
            ElevatedButton(
              onPressed: () {
                // Panggil _fetchAvatar ketika tombol ditekan
                _fetchAvatar();
              },
